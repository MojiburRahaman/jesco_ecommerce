                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            ...
                                            <span class="badges">
                                                ...
                                                <span class="sale">-{{$latest_product->Attribute->min('sell_price')}}%</span>
                                                @endif
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="single-product.html">{{$latest_product->title}}
                                                </a>
                                            </h5>
                                            <span class="price">
                                                @if ($latest_product->Attribute->min('sell_price') != '')
                                                ...
                                                <span class="new">৳
                                                    @php
                                                    $discount =
                                                    (collect($latest_product->Attribute)->min('regular_price')*$latest_product->Attribute->min('sell_price'))/100;
                                                    echo
                                                    round(collect($latest_product->Attribute)->min('regular_price')-$discount)
                                                    @endphp
                                                </span>
                                                @else
