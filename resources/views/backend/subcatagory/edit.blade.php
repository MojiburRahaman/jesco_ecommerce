            ...
            <div class="col-12">
                <form action="{{route('subcatagory.update',$subcatagory->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$subcatagory->subcatagory_name}}" name="subcatagory_name" type="text"
                            placeholder="SubCatagory Name" autocomplete="none" class="form-control @error('subcatagory_name') is-invalid                                
                            @enderror">
                    ...
                    <div class="form-group">
                        ...
                        @enderror" name="catagory_id" id="catagory_id">
                            ...
                            <option {{($subcatagory->catagory_id == $catagory->id) ? 'selected' : '' }}
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{route('subcatagory.index')}}" class="btn btn-primary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
